...
export default function Layout() {
  ...
  return (
      ...
      {/* 传统导航栏 - 隐藏于桌面端 */}
      <header 
        className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700 block md:hidden"
        role="banner"
      >
