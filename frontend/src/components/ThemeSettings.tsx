...
const codeThemeOptions: Array<{ value: CodeTheme; label: string; preview: string; category: string }> = [
  ...
  // HLJS主题系列
  { value: 'atelierCave', label: 'Atelier Cave Light', preview: '#EFECF4', category: 'HLJS' },
  { value: 'atelierCave', label: 'Atelier Cave Dark', preview: '#19171C', category: 'HLJS' },
  { value: 'atelierDune', label: 'Atelier Dune Light', preview: '#FEF6E7', category: 'HLJS' },
  { value: 'atelierDune', label: 'Atelier Dune Dark', preview: '#20201D', category: 'HLJS' },
  { value: 'atelierEstuary', label: 'Atelier Estuary Light', preview: '#F4F3EC', category: 'HLJS' },
  { value: 'atelierEstuary', label: 'Atelier Estuary Dark', preview: '#22221B', category: 'HLJS' },
  { value: 'atelierForest', label: 'Atelier Forest Light', preview: '#F1F3F4', category: 'HLJS' },
  { value: 'atelierForest', label: 'Atelier Forest Dark', preview: '#1B1918', category: 'HLJS' },
  { value: 'atelierHeath', label: 'Atelier Heath Light', preview: '#F7F3F7', category: 'HLJS' },
  { value: 'atelierHeath', label: 'Atelier Heath Dark', preview: '#1B181B', category: 'HLJS' },
  { value: 'atelierLakeside', label: 'Atelier Lakeside Light', preview: '#EBF8FF', category: 'HLJS' },
  { value: 'atelierLakeside', label: 'Atelier Lakeside Dark', preview: '#161B1D', category: 'HLJS' },
  { value: 'atelierPlateau', label: 'Atelier Plateau Light', preview: '#F4ECEC', category: 'HLJS' },
  { value: 'atelierPlateau', label: 'Atelier Plateau Dark', preview: '#1B1818', category: 'HLJS' },
  { value: 'atelierSavanna', label: 'Atelier Savanna Light', preview: '#ECF4EE', category: 'HLJS' },
  { value: 'atelierSavanna', label: 'Atelier Savanna Dark', preview: '#171C19', category: 'HLJS' },
  { value: 'atelierSeaside', label: 'Atelier Seaside Light', preview: '#F4FBFF', category: 'HLJS' },
  { value: 'atelierSeaside', label: 'Atelier Seaside Dark', preview: '#131513', category: 'HLJS' },
  { value: 'atelierSulphurpool', label: 'Atelier Sulphurpool Light', preview: '#F5F7FF', category: 'HLJS' },
  { value: 'atelierSulphurpool', label: 'Atelier Sulphurpool Dark', preview: '#202746', category: 'HLJS' },
